...
<html lang="en">
    <head>
        ...
        <link href="<?php echo ADMIN_PLUGIN_URL; ?>summernote/summernote.min.css" rel="stylesheet">
        <link href="<?php echo ADMIN_PLUGIN_URL; ?>datatables/dataTables.bootstrap.css" rel="stylesheet">
        ...
        <script src="<?php echo ADMIN_PLUGIN_URL; ?>datatables/jquery.dataTables.js"></script>
        <script src="<?php echo ADMIN_PLUGIN_URL; ?>datatables/dataTables.bootstrap.js"></script>
        <script src="<?php echo ADMIN_PLUGIN_URL; ?>confirmbox/jquery.confirm.js"></script>
        <link href="<?php echo ADMIN_PLUGIN_URL; ?>icheck/skins/all.css" rel="stylesheet">
    ...
    <body class="tooltips skin-blue">
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?php echo ($uri_2 == 'businesscategory') ? 'active selected' : ''; ?>"><a href="<?php echo ADMIN_URL . 'businesscategory'; ?>"><i class="fa fa-file-text"></i>Business Category</a></li>

                        <li class="<?php echo ($uri_2 == 'businesssubcategory') ? 'active selected' : ''; ?>"><a href="<?php echo ADMIN_URL . 'businesssubcategory'; ?>"><i class="fa fa-file-text"></i>Business Sub Category</a></li>

                        <li class="<?php echo ($uri_2 == 'company') ? 'active selected' : ''; ?>"><a href="<?php echo ADMIN_URL . 'company'; ?>"><i class="fa fa-file-text"></i>Company</a></li>

                        <li class="<?php echo ($uri_2 == 'email') ? 'active selected' : ''; ?>"><a href="<?php echo ADMIN_URL . 'page'; ?>"><i class="fa fa-file-text"></i>Pages</a></li>

                        <li class="<?php echo ($uri_2 == 'email') ? 'active selected' : ''; ?>"><a href="<?php echo ADMIN_URL . 'email'; ?>"><i class="fa fa-envelope"></i>Email Templates</a></li>

                        <li class="<?php echo ($uri_2 == 'newslettertemplate') ? 'active selected' : ''; ?>"><a href="<?php echo ADMIN_URL . 'newslettertemplate'; ?>"><i class="fa fa-envelope"></i>Newsletter Templates</a></li>

                        <li class="treeview <?php echo ($uri_1 == 'system_setting' && ($uri_2 == 'general' || $uri_2 == 'mail' || $uri_2 == 'paypal' || $uri_2 == 'facebook' || $uri_2 == 'media')) ? 'active' : ''; ?>">
                            <a href="#">
        ...
        <script src="<?php echo ADMIN_PLUGIN_URL; ?>summernote/summernote.min.js"></script>
        <script src="<?php echo ADMIN_JS_URL; ?>app.js" type="text/javascript"></script>
        <script src="<?php echo ADMIN_JS_URL; ?>dashboard.js" type="text/javascript"></script>
