<script type="text/javascript" >
    ...
    function loaDatatable(){
        ...
        dTable=jQuery('#list_data').dataTable({
            ...
            "sAjaxSource": "<?php echo ADMIN_URL . 'scrap/getjson/'; ?>" + jQuery('#categories').val() + '/' + jQuery('#sub_categories').val(),
        });
    }
    ...
    function deletedata(ele) {
        ...
        swal(
            {
                title: "Manage Scrap",
                text: "Do you Want to Delete the Scrap ?",
                type: "warning",
            ...
            function(isConfirm){
                if (isConfirm) {
                    $.ajax({
                        type: 'POST',
                        url: http_host_js + 'scrap/delete/' + current_id,
                        data: id = current_id,
                        dataType : 'JSON',
...
<div class="row">
    <div class="col-md-12 text-right">
        <a href="<?php echo ADMIN_URL . 'scrap/add'; ?>" class="btn btn-success"> Add New Scrap URL</a>
    </div>
</div>
<br />
<div class="row">
